...
import useSemesterPagination from "../hooks/useSemesterPagination";
...
function SemestersView() {
  ...
  const [editSemesterRow, setEditSemesterRow] = useState<CMSSemester | null>(null);
  const [deleteSemesterRow, setDeleteSemesterRow] = useState<CMSSemester | null>(null);
