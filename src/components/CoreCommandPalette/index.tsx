...
const NAV_ITEMS = [
  { id: "my-courses", label: "My Courses", href: "/", icon: <BookOpen size="1rem" /> },
  { id: "explore", label: "Explore Courses", href: "/courses", icon: <Compass size="1rem" /> },
];

export default function CoreCommandPalette() {
  const [{ isOpen }, setPalette] = useAtom(coreCommandPaletteAtom);
  ...
  const { data: searchData, isFetching } = useQuery({
    queryKey: queryKeys.search.core(debouncedQ),
    queryFn: () => coreSearchService.search(debouncedQ, 5),
