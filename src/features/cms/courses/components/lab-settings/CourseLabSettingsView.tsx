...
import { updateLabSchema } from "~/features/cms/courses/schemas/lab-settings/update-lab.schema";
import { z } from "zod";
import Label from "~/components/commons/Label";
import Input from "~/components/commons/Input";
import useGetLab from "~/features/cms/courses/hooks/lab-detail/useGetLab";
import DeleteLabDialog, {
  DeleteLabDialogTrigger,
} from "~/features/cms/courses/components/lab-settings/DeleteLabDialog";

export default function CourseLabSettingsView() {
