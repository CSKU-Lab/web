...
function TestCaseBlock({ order, input, output, isSelected }: TestCaseProps) {
  ...
  return (
    ...
    >
      ...
      <div className="min-h-[200px] mt-1.5">
        <ResizableSplit
          left={
            <div className="flex flex-col h-full">
              <p className="text-xs mb-1 select-none">Input</p>
              <CodeMirror
                value={input}
          ...
          right={
            <div className="flex flex-col h-full">
              <p className="text-xs mb-1 select-none">Output</p>
              <CodeMirror
                value={output}
                className="border rounded-md overflow-hidden flex-1 select-none"
                readOnly
              />
            </div>
          }
